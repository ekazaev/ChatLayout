...
class StateControllerInternalTests: XCTestCase {
    ...
    func testUpdatePreferredSize() {
        ...
        layout.controller.update(preferredSize: CGSize(width: 300, height: 100), for: ItemPath(item: 0, section: 0), kind: .footer, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 300, height: 300), for: ItemPath(item: 0, section: 0), kind: .cell, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 300, height: 100), for: ItemPath(item: 0, section: 0), kind: .header, at: .beforeUpdate)
    ...
    func testUpdatePreferredAlignment() {
        ...
        layout.controller.update(preferredSize: CGSize(width: 100, height: 100), for: ItemPath(item: 0, section: 0), kind: .footer, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 100, height: 300), for: ItemPath(item: 0, section: 0), kind: .cell, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 100, height: 100), for: ItemPath(item: 0, section: 0), kind: .header, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 100, height: 100), for: ItemPath(item: 1, section: 0), kind: .cell, at: .beforeUpdate)
