...
class StateControllerInternalTests: XCTestCase {
    func testUpdatePreferredSize() {
        ...
        layout.controller.update(preferredSize: CGSize(width: 300, height: 100), alignment: .center, interItemSpacing: 0, stickyBehavior: nil, for: ItemPath(item: 0, section: 0), kind: .footer, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 300, height: 300), alignment: .center, interItemSpacing: 0, stickyBehavior: nil, for: ItemPath(item: 0, section: 0), kind: .cell, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 300, height: 100), alignment: .center, interItemSpacing: 0, stickyBehavior: nil, for: ItemPath(item: 0, section: 0), kind: .header, at: .beforeUpdate)
    ...
    func testUpdatePreferredAlignment() {
        ...
        layout.controller.update(preferredSize: CGSize(width: 100, height: 100), alignment: .center, interItemSpacing: 0, stickyBehavior: nil, for: ItemPath(item: 0, section: 0), kind: .footer, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 100, height: 300), alignment: .center, interItemSpacing: 0, stickyBehavior: nil, for: ItemPath(item: 0, section: 0), kind: .cell, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 100, height: 100), alignment: .center, interItemSpacing: 0, stickyBehavior: nil, for: ItemPath(item: 0, section: 0), kind: .header, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 100, height: 100), alignment: .center, interItemSpacing: 0, stickyBehavior: nil, for: ItemPath(item: 1, section: 0), kind: .cell, at: .beforeUpdate)

        layout.controller.update(preferredSize: CGSize(width: 100, height: 100), alignment: .leading, interItemSpacing: 0, stickyBehavior: nil, for: ItemPath(item: 0, section: 0), kind: .footer, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 100, height: 100), alignment: .trailing, interItemSpacing: 0, stickyBehavior: nil, for: ItemPath(item: 0, section: 0), kind: .header, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 100, height: 100), alignment: .center, interItemSpacing: 0, stickyBehavior: nil, for: ItemPath(item: 0, section: 0), kind: .cell, at: .beforeUpdate)
        layout.controller.update(preferredSize: CGSize(width: 100, height: 100), alignment: .fullWidth, interItemSpacing: 0, stickyBehavior: nil, for: ItemPath(item: 1, section: 0), kind: .cell, at: .beforeUpdate)
